...
namespace SKCOMTester
{
    public partial class SKOOQuote : UserControl
    {
        ...
        void m_SKOOQuoteLib_OnNotifyTicks(short sStockIdx, int nPtr, int nDate, int nTime, int nClose, int nQty)
        {
        ...
        void m_SKOOQuoteLib_OnNotifyHistoryTicks(short sStockIdx, int nPtr, int nDate, int nTime, int nClose, int nQty)
        {
        ...
        void m_SKOOQuoteLib_OnNotifyBest10(short sStockIdx, int nBestBid1, int nBestBidQty1, int nBestBid2, int nBestBidQty2, int nBestBid3, int nBestBidQty3,
