...
namespace SKOrderTester
{
    public partial class OptionOrderControl : UserControl
    {
        ...
        private void BtnAssembleOptionAsync_Click(object sender, EventArgs e)
        {
            if (m_UserAccount == "")
            {
                MessageBox.Show("請選擇期貨帳號");
            ...
            if (OnAssembleOptionSignal != null)
            {
                OnAssembleOptionSignal(m_UserID, true, pFutureOrder);
            }
        }
        ...
        private void DisassembleAsync_Click(object sender, EventArgs e)
        {
            if (m_UserAccount == "")
            {
                MessageBox.Show("請選擇期貨帳號");
            ...
            if (OnTwoOrderToDisassemblySignal != null)
            {
                OnTwoOrderToDisassemblySignal(m_UserID, true, pFutureOrder);
            }
        }
        ...
        private void CoverAllProductAsync_Click(object sender, EventArgs e)
        {
            if (m_UserAccount == "")
            {
                MessageBox.Show("請選擇期貨帳號");
            ...
            if (int.TryParse(QtyAllCover.Text.Trim(), out nQty) == false)
            {
                MessageBox.Show("雙邊部位了解商品口數,請輸入數字");
                return;
            }
            ...
            if (OnCoverAllProductSignal != null)
            {
                OnCoverAllProductSignal(m_UserID, true, pFutureOrder);
            }
        }
    }
}
